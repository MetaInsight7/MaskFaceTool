...
from models.mask_network.prnet import PRNet
...
class FaceMasker:
    ...
    def __init__(self, is_aug):
        ...
        self.prn = PRN('models/mask_network/prnet.pth')
    ...
    def add_mask_one(self, image_path, face_lms, template_name, masked_face_path, speed):
        ...
        imsave(masked_face_path, np.uint8(new_image * 255)) 
